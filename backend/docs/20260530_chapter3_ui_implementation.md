...
**Hình 3.4. Màn hình quản lý tài khoản người dùng**

Mô tả: Admin xem danh sách user, khóa/mở khóa tài khoản, cập nhật thông tin user.

**Hình 3.5. Màn hình quản lý vai trò và quyền**

Mô tả: Admin tạo role, gán permission cho role.

**Hình 3.6. Màn hình quản lý menu theo phân quyền**
...
### 3.6.2. Workflow cấu hình đào tạo
...
### 3.7.2. Workflow thiết kế chương trình đào tạo
...
### 3.8.2. Workflow lớp học phần và điểm
...
### 3.9.2. Workflow phân công và xếp lịch
...
### 3.9.3. Workflow nghỉ/bù/tăng tiết
...
### 3.9.4. Các chức năng đã triển khai
...
### 3.10.2. Workflow quản lý phòng học

```mermaid
flowchart TD
    A["Admin tạo tòa nhà"] --> B["Tạo phòng học thuộc tòa nhà"]
    B --> C["Cấu hình sức chứa, loại phòng, trạng thái"]
    C --> D["Tạo khung tiết học"]
    D --> E["Dùng phòng và tiết khi xếp lịch"]
```

### 3.10.3. Màn hình cần chụp

**Hình 3.51. Màn hình quản lý tòa nhà**

Mô tả: Danh sách tòa nhà, mã tòa nhà, tên, địa chỉ.

**Hình 3.52. Màn hình quản lý phòng học**

Mô tả: Danh sách phòng học, sức chứa, loại phòng, trạng thái.

**Hình 3.53. Màn hình quản lý khung tiết học**

Mô tả: Cấu hình tiết học, thời gian bắt đầu và kết thúc.

## 3.11. Kiểm thử chức năng đã triển khai

### 3.11.1. Mục tiêu kiểm thử
...
### 3.11.3. Các kịch bản kiểm thử tiêu biểu
...
### 3.11.4. Màn hình cần chụp

**Hình 3.54. Kết quả kiểm thử đăng nhập và phân quyền**

Mô tả: Minh họa user chỉ thấy menu được cấp quyền.

**Hình 3.55. Kết quả kiểm thử tạo sinh viên thành công**

Mô tả: Sinh viên được tạo và có tài khoản hệ thống.

**Hình 3.56. Kết quả kiểm thử validate lỗi khi chọn sai quan hệ**

Mô tả: Giao diện hiển thị thông báo lỗi từ backend.

**Hình 3.57. Kết quả kiểm thử đăng ký học lại/học cải thiện**

Mô tả: Sinh viên chỉ thấy học phần đủ điều kiện.

**Hình 3.58. Kết quả kiểm thử điều chỉnh lịch**
...
## 3.13. Gợi ý danh sách hình ảnh đưa vào báo cáo
