...
public interface ScheduleRepository extends JpaRepository<Schedule, UUID> {
    ...
    @Query("""
            ...
            """)
    List<Schedule> findActiveAutoGeneratedRecurringByCourseClass(@Param("courseClassId") UUID courseClassId);
    ...
    @Query("""
            ...
            WHERE s.courseClass.courseClassId = :courseClassId
              ...
              AND s.isActive = true
            """)
    List<Schedule> findActiveRecurringByCourseClass(@Param("courseClassId") UUID courseClassId);
