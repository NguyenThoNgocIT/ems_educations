        ...
        http
                ...
                .authorizeHttpRequests(req ->
                        req.requestMatchers(WHITE_LIST_URL)
                                ...
                                .requestMatchers("/api/v1/admin/subjects/**").hasAnyRole("ADMIN", "MANAGER")
                                .requestMatchers("/api/v1/admin/training-programs/**").hasAnyRole("ADMIN", "MANAGER")
                                .requestMatchers("/api/v1/admin/majors/**").hasAnyRole("ADMIN", "MANAGER")
                                .requestMatchers("/api/v1/admin/departments/**").hasAnyRole("ADMIN", "MANAGER")
                                .requestMatchers("/api/v1/admin/prerequisites/**").hasAnyRole("ADMIN", "MANAGER")
                                .requestMatchers("/api/v1/admin/semesters/**").hasAnyRole("ADMIN", "MANAGER")
                                .requestMatchers("/api/v1/admin/grade-scales/**").hasAnyRole("ADMIN", "MANAGER")
