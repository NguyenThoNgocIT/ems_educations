...
const AppHeader: React.FC<AppHeaderProps> = ({ role = "admin" }) => {
  ...
  return (
    <header 
      ...
      `}
    >
      {/* Container bên trong dùng px-4 lg:px-6 để tạo khoảng cách an toàn với lề của Header.
        Khi Sidebar đè lên, nội dung bên trong vẫn đẩy ra chuẩn chỉ không bị che khuất.
      */}
