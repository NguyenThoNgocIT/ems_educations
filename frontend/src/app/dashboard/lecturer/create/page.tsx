...
const mockStudents: Record<string, Student[]> = {
  ...
  'class2': [
    ...
    { id: '6', studentCode: 'SV006', studentName: 'Vũ Thị F' },
  ],
};
...
export default function CreateAttendancePage() {
  ...
  useEffect(() => {
    if (selectedClass && mockStudents[selectedClass]) {
      const studentList = mockStudents[selectedClass];
                    ...
                    <tbody>
                      {students.map((student) => (
                        <tr key={student.id} className="border-b hover:bg-muted/30">
                          ...
                          <td className="py-3 px-4 text-sm">{student.studentName}</td>
