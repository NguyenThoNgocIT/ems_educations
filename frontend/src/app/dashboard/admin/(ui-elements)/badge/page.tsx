  ...
  return (
    <div>
      ...
      <div className="space-y-5 sm:space-y-6">
        <div className="rounded-2xl border border-slate-200 bg-white dark:border-slate-800 dark:bg-white/[0.03]">
          <div className="px-6 py-5">
            <h3 className="text-base font-medium text-slate-800 dark:text-white/90 leading-relaxed">
              With Light Background
            </h3>
          </div>
          <div className="border-t border-slate-100 p-6 xl:p-10 dark:border-slate-800">
