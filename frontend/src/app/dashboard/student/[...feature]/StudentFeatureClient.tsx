...
import type { StudentAnnouncement, StudentDocument, StudentExam, StudentRegistration, StudentSupportRequest, StudentTuition } from '@/types/student-portal';
...
export default function StudentFeatureClient() {
  ...
  return <FeaturePlaceholder homeHref="/dashboard/student/notifications" roleLabel="Sinh viên" />;
}
...
function StudentSection({
  ...
  return (
    <div className="flex w-full flex-col gap-5 pb-8">
      ...
      {children}
      <Link href="/dashboard/student/notifications" className="w-fit text-sm font-semibold text-emerald-700 hover:underline dark:text-emerald-300">
        Quay lại thông báo
      </Link>
    </div>
  );
