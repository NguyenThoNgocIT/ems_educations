        ...
        <div className="overflow-hidden rounded-xl border bg-white shadow-sm dark:border-slate-700 dark:bg-slate-900">
                ...
                >
                  ...
                  <td className="p-4">
                    <div className="flex w-fit items-center gap-2 rounded border bg-slate-50 px-2 py-1 dark:border-slate-600 dark:bg-slate-800">
                      ...
                      <span className="text-xs font-bold tracking-normal text-slate-900 dark:text-slate-200">
                        {promo.code}
                      </span>
                    </div>
                  </td>
                  ...
                  <td className="p-4 text-xs font-bold text-slate-900 dark:text-slate-300">
                    {promo.packageType}
                  </td>
                  ...
                  <td className="dark:text-slate-4 leading-relaxed00 p-4 text-center text-sm font-bold text-slate-600">
                    {promo.used}
                  </td>
          ...
          <div className="flex items-center justify-end gap-4 border-t bg-slate-50/20 p-4 dark:border-slate-700">
            ...
            <div className="flex items-center gap-1">
              ...
              <button className="flex h-7 w-7 items-center justify-center rounded-lg border border-blue-200 bg-blue-50 text-xs font-bold text-indigo-700 shadow-sm">
                1
              </button>
              <button className="p-1 text-slate-400 hover:text-slate-900">
