      ...
      <div className="mx-auto max-w-[1400px] space-y-4">
        ...
        <div className="flex items-center justify-between rounded-xl border bg-white p-4 shadow-sm dark:border-slate-700 dark:bg-slate-900">
          ...
          <button
            ...
            className="flex items-center gap-2 rounded-lg bg-blue-500 px-6 py-2 font-bold text-white shadow-md shadow-blue-500/20 transition-all hover:bg-blue-600"
          >
                ...
                >
                  ...
                  <td className="p-6 align-top">
                    <div className="space-y-3">
                      <h4 className="text-slate-9 leading-relaxed00 text-sm leading-snug leading-tight font-bold dark:text-white">
                        {combo.name}
                      </h4>
                      <span className="inline-block rounded-lg border border-blue-400 bg-blue-50/50 px-3 py-1 text-[11px] font-medium text-indigo-600">
                        {combo.status}
                      </span>
                    </div>
                  </td>
