    ...
    <div className="min-h-screen bg-slate-50 p-6 font-sans dark:bg-black">
      <div className="mx-auto max-w-[1400px] space-y-4">
        ...
        <div className="flex gap-3">
          <button className="dark:text-slate-3 leading-relaxed00 flex items-center gap-2 rounded-lg border bg-white px-4 py-2 text-sm font-bold text-slate-600 shadow-sm transition-all hover:bg-slate-50 dark:border-slate-600 dark:bg-slate-900">
          ...
          <button
            ...
            className="flex items-center gap-2 rounded-lg bg-blue-500 px-6 py-2 text-sm font-bold text-white shadow-md shadow-blue-500/20 transition-all hover:bg-blue-600"
          >
        ...
        <div className="overflow-hidden rounded-xl border bg-white shadow-sm dark:border-slate-700 dark:bg-slate-900">
          <table className="w-full border-collapse">
            <thead>
              <tr className="border-b bg-slate-50/50 text-left text-sm font-extrabold tracking-wider text-slate-900 dark:border-slate-700 dark:bg-slate-800/30 dark:text-white">
                ...
                >
                  ...
                  <td className="p-4 pt-5 align-top">
                    <div className="space-y-1">
                      <h4 className="text-slate-9 leading-relaxed00 text-sm font-extrabold tracking-tight dark:text-white">
                        {lead.name}
                      </h4>
                      ...
                      {lead.status === "Cần tư vấn lại" && (
                        <span className="mt-2 inline-block rounded border border-orange-200 px-2 py-0.5 text-[10px] font-bold text-orange-500">
                          Cần tư vấn lại
                        </span>
                      )}
                    </div>
                  ...
                  <td className="p-4 pt-5 align-top">
                    <div className="space-y-1">
                      <p className="dark:text-slate-2 leading-relaxed00 text-sm leading-relaxed font-bold text-slate-900">
                        {lead.phone}
                      </p>
                  ...
                  <td className="p-4 pt-5 align-top">
                    <div className="flex flex-col gap-2">
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <span className="rounded border border-slate-200 bg-slate-50 px-3 py-1 text-[10px] font-bold text-slate-600">
                          {lead.quality}
                        </span>
                      </div>
                    </div>
          ...
          <div className="flex items-center justify-between border-t bg-slate-50/30 p-4 dark:border-slate-700">
            ...
            <div className="flex items-center gap-2">
              ...
              <button className="flex h-8 w-8 items-center justify-center rounded-lg text-xs font-bold text-slate-400 transition-all hover:bg-slate-50">
                2
              </button>
              <button className="p-1 text-slate-400 hover:text-slate-900">
