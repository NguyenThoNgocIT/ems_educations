      ...
      <div className="animate-in zoom-in flex max-h-[90vh] w-full max-w-3xl flex-col overflow-hidden rounded-2xl bg-white shadow-2xl duration-200 dark:bg-slate-900">
        ...
        <div className="sticky bottom-0 z-10 flex items-center justify-between border-t bg-slate-50/50 p-4 dark:border-slate-700 dark:bg-slate-800/50">
          ...
          <div className="flex gap-2">
            <button
              onClick={onClose}
              className="rounded-lg bg-red-500/90 px-6 py-2 text-sm font-bold text-white shadow-sm transition-all hover:bg-red-600 active:scale-95"
            >
              Hủy
            </button>
            <button className="rounded-lg bg-blue-500 px-6 py-2 text-sm font-bold text-white shadow-md shadow-blue-500/20 transition-all hover:bg-blue-600 active:scale-95">
              Xác nhận
            </button>
          </div>
        </div>
