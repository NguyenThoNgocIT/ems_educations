...
export default function FullScreenModal() {
  ...
  return (
    <ComponentCard title="Full Screen Modal">
      ...
      >
        <div className="fixed top-0 left-0 flex h-screen w-full flex-col justify-between overflow-x-hidden overflow-y-auto bg-white p-6 lg:p-10 dark:bg-slate-900">
          <div>
            <h4 className="text-title-sm mb-7 font-semibold text-slate-900 dark:text-white/90 leading-snug">
              Modal Heading
            </h4>
            <p className="text-sm leading-6 text-slate-600 dark:text-slate-4 leading-relaxed00 leading-relaxed">
            ...
            <p className="mt-5 text-sm leading-6 text-slate-600 dark:text-slate-4 leading-relaxed00 leading-relaxed">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit.
              Pellentesque euismod est quis mauris lacinia pharetra. Sed a
              ligula ac odio condimentum aliquet a nec nulla. Aliquam bibendum
