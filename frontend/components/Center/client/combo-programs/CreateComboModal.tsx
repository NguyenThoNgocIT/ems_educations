    ...
    <div className="fixed inset-0 z-[150] flex items-center justify-center bg-black/50 p-4 backdrop-blur-sm">
      <div className="animate-in zoom-in flex max-h-[90vh] w-full max-w-2xl flex-col overflow-hidden rounded-2xl bg-white shadow-2xl duration-200 dark:bg-slate-900">
        ...
        <div className="flex items-center justify-between border-b bg-white p-5 dark:border-slate-700 dark:bg-slate-900">
          <h2 className="text-lg font-semibold font-Inter tracking-tight text-slate-900 dark:text-white leading-normal leading-snug">
        ...
        <div className="custom-scrollbar flex-1 space-y-6 overflow-y-auto p-6">
          ...
          <section className="space-y-4">
            <h3 className="flex items-center gap-2 border-b pb-2 text-sm font-semibold font-Inter text-indigo-600 dark:border-slate-700 leading-tight leading-snug">
              <Tag size={16} /> THÔNG TIN COMBO
            </h3>
            <div className="space-y-1">
              <label className="text-xs font-Inter text-slate-600">
                Tên combo *
              </label>
              <input
                type="text"
                placeholder="Ví dụ: Trọn gói từ A1"
                className="w-full rounded-lg border bg-white p-2.5 text-sm font-semibold font-Inter outline-none focus:ring-1 focus:ring-indigo-500 dark:border-slate-700 dark:bg-slate-950"
                onChange={(e) =>
          ...
          <section className="space-y-4">
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
              <div className="space-y-1">
                ...
                <input
                  ...
                  className="w-full rounded-lg border bg-white p-2.5 text-sm font-semibold font-Inter outline-none focus:ring-1 focus:ring-indigo-500dark:border-slate-700 dark:bg-slate-950"
                  onChange={(e) =>
                    setFormData({
                      ...formData,
              ...
              <div className="space-y-1">
                ...
                <select
                  className="w-full rounded-lg border bg-white p-2.5 text-sm font-semibold font-Inter dark:border-slate-700 dark:bg-slate-950"
                  onChange={(e) =>
              ...
              <div className="space-y-1">
                ...
                <input
                  type="number"
                  className="w-full rounded-lg border bg-white p-2.5 text-sm font-semibold font-Inter text-red-500 dark:border-slate-700 dark:bg-slate-950"
                  onChange={(e) =>
                    setFormData({
                      ...formData,
              ...
              <div className="space-y-1">
                <label className="text-xs font-Inter text-slate-600 italic">
                  % Giảm dự kiến
                </label>
                <div className="rounded-lg border bg-slate-50 p-2.5 text-sm font-semibold font-Inter text-slate-6 leading-relaxed00 dark:border-slate-600 dark:bg-slate-800">
            ...
            <div className="flex items-center justify-between rounded-xl border border-green-200 bg-green-50 p-4 dark:border-green-800 dark:bg-green-900/10">
              <span className="text-sm font-semibold font-Inter text-green-600">
                Tổng tiền combo:
              </span>
              <span className="text-xl font-semibold font-Inter text-green-600 leading-snug">
        ...
        <div className="flex items-center justify-between border-t bg-slate-50/50 p-4 dark:border-slate-700 dark:bg-slate-800/50">
          ...
          <div className="flex gap-2">
            <button
              onClick={onClose}
              className="rounded-lg bg-red-500/90 px-6 py-2 text-sm font-semibold text-white transition-all hover:bg-red-600"
            >
              Hủy
            </button>
            <button className="flex items-center gap-2 rounded-lg bg-blue-500 px-6 py-2 text-sm font-semibold text-white shadow-md shadow-blue-500/20 transition-all hover:bg-blue-600">
