...
const RegistrationPage = () => {
  ...
  const FieldLabel = ({
    ...
    <label className="mb-1 block text-xs font-semibold font-Inter tracking-tight text-slate-600">
    ...
    <div className="min-h-screen bg-slate-50 p-6 font-Inter dark:bg-black">
      <div className="mx-auto max-w-4xl overflow-hidden rounded-2xl border bg-white shadow-xl dark:border-slate-700 dark:bg-slate-900">
        ...
        <div className="border-b dark:border-slate-700">
          <div className="p-3">
            <h1 className="text-xl font-semibold font-Inter tracking-normal text-black dark:text-white leading-snug leading-snug">
              Hệ thống Đăng ký
            </h1>
          </div>
          <div className="flex gap-8 px-6">
            <button
              ...
              className={`flex items-center gap-2 border-b-2 pb-4 text-sm font-semibold transition-all ${activeTab === "new" ? "border-indigo-500 text-indigo-600" : "border-transparent text-slate-400 hover:text-slate-600"}`}
            >
              <PlusCircle size={18} /> Đăng ký mới
            </button>
            <button
              onClick={() => setActiveTab("additional")}
              className={`flex items-center gap-2 border-b-2 pb-4 text-sm font-semibold transition-all ${activeTab === "additional" ? "border-indigo-500 text-indigo-600" : "border-transparent text-slate-400 hover:text-slate-600"}`}
            >
        ...
        <div className="custom-scrollbar max-h-[75vh] space-y-8 overflow-y-auto p-8">
          ...
          {activeTab === "new" && (
            <div className="animate-in fade-in slide-in-from-left-4 space-y-8 duration-300">
              ...
              <section className="space-y-4">
                ...
                <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                  ...
                  <div className="space-y-1">
                    ...
                    <input
                      ...
                      className="w-full rounded-xl border bg-white p-3 text-sm font-semibold outline-none focus:ring-2 focus:ring-indigo-500/20 dark:border-slate-700 dark:bg-slate-950"
                    />
                  </div>
                  <div className="space-y-1">
                    ...
                    <input
                      type="email"
                      placeholder="Email"
                      className="w-full rounded-xl border p-3 text-sm font-semibold dark:border-slate-700"
                    />
                  </div>
                  <div className="space-y-1">
                  ...
                  <div className="space-y-1">
                    ...
                    <div className="relative">
                      <select className="w-full appearance-none rounded-xl border p-3 text-sm font-semibold dark:border-slate-700">
                ...
                <div className="space-y-1">
                  ...
                  <textarea
                    ...
                    className="h-24 w-full resize-none rounded-xl border p-3 text-sm font-semibold dark:border-slate-700"
                  />
                </div>
              </section>
              ...
              <section className="space-y-4">
                <h3 className="flex items-center gap-2 border-b pb-2 text-sm font-semibold text-indigo-600 leading-tight leading-snug">
              ...
              <section className="space-y-6">
                ...
                <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      <select className="w-full appearance-none rounded-2xl border bg-slate-50 p-4 text-sm font-semibold outline-none dark:border-slate-700 dark:bg-slate-950">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      <input
                        type="date"
                        className="w-full rounded-2xl border bg-slate-50 p-4 text-sm font-semibold outline-none dark:border-slate-700 dark:bg-slate-950"
                      />
                    </div>
                  </div>
                  <div className="space-y-2">
        ...
        <div className="flex justify-end gap-3 border-t bg-slate-50 p-6 dark:border-slate-700 dark:bg-slate-900/50">
          <button className="flex items-center gap-2 rounded-xl bg-red-500/10 px-8 py-3 font-semibold text-red-500 transition-all hover:bg-red-500 hover:text-white">
            Hủy bỏ
          </button>
          <button className="flex items-center gap-2 rounded-xl bg-blue-600 px-10 py-3 font-semibold text-white shadow-lg shadow-blue-600/20 transition-all hover:bg-blue-700 active:scale-95">
