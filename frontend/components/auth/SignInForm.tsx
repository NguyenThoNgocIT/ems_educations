  ...
  return (
    <div className="animate-in fade-in flex w-full flex-1 flex-col duration-500 lg:w-1/2">
      <div className="mx-auto flex w-full max-w-md flex-1 flex-col justify-center">
        <div className="mb-8">
          <h1 className="text-title-sm sm:text-title-md mb-2 leading-snug font-semibold font-Inter text-slate-900 dark:text-white">
            Sign In
          </h1>
          <p className="dark:text-slate-4 leading-relaxed00 text-sm leading-relaxed font-Inter text-slate-500">
          ...
          >
            ...
            <div className="relative z-10 flex h-full w-full items-center justify-between rounded-[13px] bg-amber-400 px-4 py-4 transition-colors group-hover:bg-amber-300">
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="flex items-center gap-1 rounded-lg bg-slate-950 px-2.5 py-1.5 text-[11px] font-semibold font-Inter text-amber-400 shadow-lg">
                  <Zap
                    size={14}
                    fill="currentColor"
                ...
                <span className="text-slate-9 leading-relaxed00 text-sm font-semibold font-Inter tracking-normal italic">
        ...
        <div className="relative py-6">
          ...
          <div className="relative flex justify-center text-xs font-semibold font-Inter tracking-widest text-slate-400">
          ...
          */}
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <span className="dark:text-slate-4 leading-relaxed00 text-sm font-Inter text-slate-600">
                Ghi nhớ tôi
              </span>
            </div>
            <Link
              href="#"
              className="text-sm font-semibold font-Inter text-indigo-600 hover:text-indigo-700 dark:text-indigo-400"
            >
              Quên mật khẩu?
            </Link>
          </div>
          <Button
            className="w-full rounded-xl bg-indigo-600 py-4 font-semibold font-Inter text-white shadow-lg shadow-indigo-100 hover:bg-indigo-700 dark:shadow-none"
            size="sm"
          >
            Sign in
          </Button>
        ...
        <div className="mt-8 text-center">
          <p className="dark:text-slate-4 leading-relaxed00 text-sm leading-relaxed font-Inter text-slate-500">
            ...
            <Link
              href="/signup"
              className="ml-1 font-semibold font-Inter text-indigo-600 hover:underline"
            >
              Sign Up
            </Link>
          </p>
      ...
      {isTrialModalOpen && (
        <div className="animate-in fade-in fixed inset-0 z-[100] flex items-center justify-center bg-slate-900/60 p-4 backdrop-blur-md duration-300">
          <div className="animate-in zoom-in relative w-full max-w-2xl rounded-[32px] border border-slate-100 bg-white p-10 shadow-2xl duration-300 dark:border-slate-800 dark:bg-slate-900">
            ...
            <h2 className="mb-2 text-center text-2xl leading-snug font-semibold font-Inter text-slate-900 dark:text-white">
            ...
            <div className="grid grid-cols-2 gap-4 sm:grid-cols-3">
              {trialRoles.map((role) => (
                ...
                >
                  ...
                  <span
                    className={`text-center text-[11px] font-semibold font-Inter tracking-widest ${selectedRole === role.id ? "text-indigo-600" : "text-slate-500 dark:text-slate-400"}`}
                  >
                    {role.label}
                  </span>
                </button>
            ...
            <div className="mt-12">
              <button
                ...
                className={`w-full rounded-2xl py-4 text-base font-semibold font-Inter shadow-xl transition-all ${selectedRole ? "bg-indigo-600 text-white shadow-indigo-200 hover:bg-indigo-700 active:scale-95" : "cursor-not-allowed bg-slate-100 text-slate-400 dark:bg-slate-800"}`}
              >
